...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Cetak PDF Data Gaji</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('/admin/gaji') }}">Gaji</a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Cetak PDF Data Gaji Bulanan Sales
                        </h3>
                    </div>

                    <div class="card-body">

                        <form action="{{ route('cetakGaji') }}" method="get" enctype="multipart/form-data">
                            @csrf
